/****************************************************************************
 *
 * Terminal Guidance - Custom QGC Build
 * Based on QGroundControl custom-example
 *
...
Item {
    ...
    // Terminal Guidance properties
    property bool   _tgPanelVisible:        false
    ...
    //=========================================================================
    //-- Terminal Guidance Control Panel
    //=========================================================================

    // Toggle button for the tracking panel (top left, below toolstrip)
    Rectangle {
        id:                     tgToggleButton
        anchors.left:           parent.left
        anchors.top:            parent.top
        ...
        width:                  tgToggleRow.width + ScreenTools.defaultFontPixelWidth * 2
        height:                 ScreenTools.defaultFontPixelHeight * 2.5
        color:                  terminalGuidancePanel && terminalGuidancePanel.connected ? qgcPal.colorGreen : qgcPal.window
        ...
        Row {
            ...
            QGCColoredImage {
                ...
                color:                  tgToggleButton.color === qgcPal.colorGreen ? "white" : qgcPal.text
                fillMode:               Image.PreserveAspectFit
            }
        ...
        MouseArea {
            anchors.fill:   parent
            onClicked:      _tgPanelVisible = !_tgPanelVisible
        }
    }

    // Terminal Guidance Control Panel - loaded via Loader since it's a custom component
    Loader {
        id:                     terminalGuidancePanelLoader
        anchors.left:           parent.left
        anchors.top:            tgToggleButton.bottom
        anchors.leftMargin:     parentToolInsets.leftEdgeTopInset + _toolsMargin
        anchors.topMargin:      _toolsMargin
        visible:                _tgPanelVisible
        z:                      QGroundControl.zOrderWidgets
        source:                 "qrc:/Custom/qml/QGroundControl/FlyView/TerminalGuidancePanel.qml"
    }

    // Alias for accessing the panel's properties
    property alias terminalGuidancePanel: terminalGuidancePanelLoader.item
}
